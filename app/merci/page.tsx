          ...
          <div className="space-y-6 mb-8">
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Nous étudions votre demande de peinture intérieure, pose de parquet ou toile décorative et préparons notre intervention.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Notre équipe JASEL vous contacte pour affiner votre demande et planifier vos services.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Recevez un devis détaillé pour vos services de peinture intérieure, pose de parquet ou toile décorative.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-gray-900">06 87 18 47 96</p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-gray-900">mehtapmurat@hotmail.fr</p>
